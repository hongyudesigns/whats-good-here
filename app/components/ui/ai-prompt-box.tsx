...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => (
    <textarea
      className={cn(
        "flex w-full rounded-md border-none bg-transparent px-3 py-2.5 text-base text-[#1A1A1A] placeholder:text-[#6B6B6B] focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 min-h-[44px] resize-none scrollbar-thin scrollbar-thumb-[#444444] scrollbar-track-transparent hover:scrollbar-thumb-[#555555]",
        className,
      )}
      ref={ref}
      rows={1}
      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "rounded-3xl p-1 shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300",
              className,
            )}
    ...
    return (
      <>
        <PromptInput
          ...
          className={cn(
            "w-full bg-[#FFFFFF] border-[rgba(0,0,0,0.1)] text-[#1A1A1A] shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300 ease-in-out",
            className,
          )}
          disabled={false}
